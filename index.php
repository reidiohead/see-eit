...
<body class="index-body">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
					...
					<br>
					<img src="LOGO.png" alt="SEE-EIT Logo" class="logo">
						...
						<div class="panel-body">
							<form class="frm_index">
								<fieldset>
									...
									<a href="./member/login" class="btn-admin"> Go to Member's Page</a>
									</div>
								</fieldset>
							</form>
						</div>
	...
	<!-- Copyright Link -->
<div style="position: fixed; bottom: 10px; left: 10px; font-size: 20px;">
    © <a href="about.php" style="text-decoration: none; color: inherit;">Tres Estudyantes</a>
</div>
